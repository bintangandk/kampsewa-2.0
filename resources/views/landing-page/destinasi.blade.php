    ...
    <div class="container-fluid packages py-5">
        <div class="container py-5">
            ...
            <div class="packages-carousel owl-carousel d-flex flex-coloumn gap-4">
                <div class="packages-item">
                    <div class="packages-img">
                        ...
                        <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute"
                            ...
                            <small class="flex-fill text-center border-end py-2"><i
                                    class="fa fa-map-marker-alt me-2"></i>Desa Tempurejo</small>
                        </div>
                    ...
                    <div class="packages-content bg-light">
                        <div class="p-4 pb-0">
                            ...
                            <p class="mb-4">Jember memiliki banyak sekali wisata yang menarik dan lengkap, salah
                                satunya yaitu taman Galaxy. Taman Galaxy merupakan sebuah objek wisata yang didalamnya
                                menyuguhkan keindahan taman seperti bukit Teletubbies dan juga kebun binatang.
                                Diberi nama Bukit Teletubbies karena bentuk dan rumputnya seperti tempat dalam film
                                cartoon Teletubbies.</p>
                        </div>
                ...
                <div class="packages-item">
                    <div class="packages-img">
                        ...
                        <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute"
                            style="width: 100%; bottom: 0; left: 0; z-index: 5;">
                            <small class="flex-fill text-center border-end py-2"><i
                                    class="fa fa-map-marker-alt me-2"></i>Kecamatan Dlingo, Bantul</small>
                        </div>
                    ...
                    <div class="packages-content bg-light">
                        <div class="p-4 pb-0">
                            ...
                            <p class="mb-4">Fasilitas yang diberikan juga sangat lengkap, mulai dari kasur, kamar
                                mandi pribadi, hingga sofa yang empuk.
                                Tidak hanya berkemah, wisatawan juga bisa mengunjungi beberapa spot foto instagrammable
                                di destinasi wisata Seribu Batu Songgo Langit.
                                Seperti jembatan panjang dari kayu, rumah ala film Hobbit, puncak Songgo Langit yang
                                indah, hingga bermain flying fox dan jalan-jalan naik jeep.</p>
                        </div>
                        <div class="row bg-primary rounded-bottom mx-0">
                        </div>
                    </div>
                ...
                <div class="packages-item">
                    <div class="packages-img">
                        <img src="{{ asset('template/envato/img/tempat-Bali.jpg') }}"
                            class="img-fluid w-100 rounded-top" alt="Image">
                        <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute"
                            style="width: 100%; bottom: 0; left: 0; z-index: 5;">
                            <small class="flex-fill text-center border-end py-2"><i
                                    class="fa fa-map-marker-alt me-2"></i>Kabupaten Tabanan</small>
                        </div>
                    ...
                    <div class="packages-content bg-light">
                        <div class="p-4 pb-0">
                            ...
                            <small class="text-uppercase">Salah satu pura terfavorit dan sangat disucikan di
                                Bali</small>
                            <div class="mb-3">
                                <small class="fa fa-star text-primary"></small>
                                <small class="fa fa-star text-primary"></small>
                            ...
                            <p class="mb-4">salah satu Pura (Tempat Ibadah Umat Hindu) yang sangat disucikan di Bali,
                                Indonesia. Di sini ada dua Pura yang terletak di atas batu besar. Satu terletak di atas
                                bongkahan batu dan satunya terletak di atas tebing mirip dengan Pura Uluwatu. Pura Tanah
                                Lot ini merupakan bagian dari Pura Dang Kahyangan. Pura Tanah Lot merupakan Pura laut
                                tempat pemujaan dewa-dewa penjaga laut. Tanah Lot terkenal sebagai tempat yang indah
                                untuk melihat matahari terbenam.</p>
                        </div>
                        <div class="row bg-primary rounded-bottom mx-0">
                        </div>
                    </div>
                ...
                <div class="packages-item">
                    <div class="packages-img">
                        ...
                        <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute"
                            style="width: 100%; bottom: 0; left: 0; z-index: 5;">
                            <small class="flex-fill text-center border-end py-2"><i
                                    class="fa fa-map-marker-alt me-2"></i>Desa Ungasan</small>
                        </div>
                    ...
                    <div class="packages-content bg-light">
                        <div class="p-4 pb-0">
                            ...
                            <small class="text-uppercase">salah satu pantai di Bali yang jarang disentuh
                                wisatawan</small>
                            <div class="mb-3">
                                <small class="fa fa-star text-primary"></small>
                                <small class="fa fa-star text-primary"></small>
                            ...
                            <p class="mb-4">Lokasinya memang agak susah ditemukan, dan untuk bisa menuju ke pantai
                                ini, kamu harus menuruni ratusan anak tangga yang pastinya akan bikin kaki pegal-pegal
                                saat harus pulang. Tapi begitu kamu sampai di beberapa anak tangga terakhir, kamu akan
                                melupakan rasa lelahmu karena pemandangan yang sangat keren.</p>
                        </div>
                        <div class="row bg-primary rounded-bottom mx-0">
                        </div>
                    </div>
                ...
                <div class="packages-item">
                    <div class="packages-img">
                        ...
                        <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute"
                            style="width: 100%; bottom: 0; left: 0; z-index: 5;">
                            <small class="flex-fill text-center border-end py-2"><i
                                    class="fa fa-map-marker-alt me-2"></i>Kabupaten Klungkung</small>
                        </div>
                    ...
                    <div class="packages-content bg-light">
                        <div class="p-4 pb-0">
                            ...
                            <p class="mb-4">Tapi tau gak sih, kamu sebenarnya bisa turun mengikuti tangganya yang
                                curam sampai ke pantainya di dasar? Memang masih jarang banget turis yang mau susah
                                payah melakukannya karena memang sangat melelahkan. Tapi ketika kamu sampai di dasar,
                                pantai di Kelingking Beach ini benar-benar akan membayar semua usaha kamu!</p>
                        </div>
                        <div class="row bg-primary rounded-bottom mx-0">
                        </div>
                    </div>
                ...
                <div class="packages-item">
                    <div class="packages-img">
                        <img src="{{ asset('template/envato/img/tempat-purwo.webp') }}"
                            class="img-fluid w-100 rounded-top" alt="Image">
                        <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute"
                            style="width: 100%; bottom: 0; left: 0; z-index: 5;">
                            <small class="flex-fill text-center border-end py-2"><i
                                    class="fa fa-map-marker-alt me-2"></i>Banyuwangi</small>
                        </div>
                    ...
                    <div class="packages-content bg-light">
                        <div class="p-4 pb-0">
                            ...
                            <small class="text-uppercase">taman nasional, semula berstatus Suaka Margasatwa Banyuwangi
                                Selatan</small>
                            <div class="mb-3">
                                <small class="fa fa-star text-primary"></small>
                                <small class="fa fa-star text-primary"></small>
                            ...
                            <p class="mb-4">Taman Nasional Alas Purwo merupakan kawasan konservasi yang terletak di
                                ujung timur Pulau Jawa. Secara administratif, Alas Purwo masuk wilayah Kecamatan
                                Tegaldlimo dan Kecamatan Purwoharjo, Kabupaten Banyuwangi, Jawa Timu</p>
                        </div>
                        <div class="row bg-primary rounded-bottom mx-0">
                        </div>
                    </div>
                            ...
                            <div class="col-xl-4">
                                <div class="destination-img h-100">
                                    <img class="img-fluid rounded w-100 h-100"
                                        ...
                                        style="object-fit: cover; min-height: 300px;" alt="Destinasi Wisata">
                                    <div class="destination-overlay p-4">
                                        <a href="#"
                                            class="btn btn-primary text-white rounded-pill border py-2 px-3">20
                                            Photos</a>
                    ...
                    <div id="tab-5" class="tab-pane fade show p-0">
                        <div class="row g-4">
                            <div class="col-lg-6">
                                <div class="destination-img">
                                    <img class="img-fluid w-100 rounded"
                                        src="{{ asset('template/envato/img/tempat-ranau.webp') }}"
                                        alt="Destinasi Wisata">
                                    <div class="destination-overlay p-4">
                                        <a href="#"
                                            class="btn btn-primary text-white rounded-pill border py-2 px-3">20
