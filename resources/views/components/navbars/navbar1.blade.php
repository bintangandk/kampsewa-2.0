        ...
        <div class="mx-auto max-w-7xl px-8 sm:px-6 lg:px-8">
            <div class="relative flex h-[100px] items-center justify-between">
                ...
                <div class="--title-icon-more flex items-center gap-4">
                    <div class="--more-icon-slide hidden small-desktop:block"><i
                            class="text-[28px] font-bold bi bi-list"></i></div>
                    <div class="_title">
                    ...
                    <div id="form-notification-as-read">
                        <div class="_icon" id="iconButton">
                            <div
                                ...
                                <div id="count-nofication"
                                    class="{{ $user_baru_terdaftar->count() > 0 ? '' : 'hidden' }} absolute top-0 right-0 mr-[-10px] font-bold w-[25px] h-[25px] text-[12px] bg-red-500 rounded-full text-white flex justify-center items-center">
                        ...
                        @else
                            @foreach ($user_baru_terdaftar as $user)
                                <a href="{{ route('detail-pengguna.index', ['fullname' => $user->name]) }}"
                                    class="cursor-pointer flex hover:bg-gray-100 justify-between py-6 px-4 bg-white">
